...
const SwapComponent = () => {
  ...
  return (
    <div className="md:p-4 p-2 bg-[#404040] center md:w-[586px] rounded-[34px]">
      <div className="bg-[#2C2C2C] w-full text-white center flex-col gap-4 rounded-[24px] md:p-5 p-2">
        <div className="between w-full mb-4 px-2">
          <h2 className="md:text-[18px]">Swap</h2>
